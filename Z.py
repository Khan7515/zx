...
\033[1;91mS  ~O  S     ZOHAIB     S     S  ~O  S    b 
...
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;95m AUTHOR   : MR-Zohaib
...
def menu():
    ...
    print("\033[1;97m [0] File cloning )
    print("\033[1;98m [0] Main Menu Back")
    print(50*"-")
    menu_select()
def menu_select():
...
def crack():
	...
	print("\033[1;97m[0]\033[1;91m File cloning )
	print(50*"-")
	crack_select()
def crack_select():
